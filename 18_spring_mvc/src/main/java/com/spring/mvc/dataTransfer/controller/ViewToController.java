...
public class ViewToController {
	...
	//	public String transfer4(//@ModelAttribute MemberDto memberDto 혼합도 가능
	//		@RequestParam("isPC") String isPC ,
	//		@RequestParam("locationCd") int locationCd,
	//		@RequestParam("lang") String lang) {

	//	public String transfer4(boolean isPC , int locationCd, String lang) {
	//	public String transfer4(@RequestParam(name="isPC" , defaultValue = "false") boolean isPC , @RequestParam(name="locationCd" , defaultValue = "-1") int locationCd,@RequestParam(name="lang" , defaultValue = "kor") String lang) {
		public String transfer4(@RequestParam("isPC") String isPC ,
								@RequestParam("locationCd") int locationCd,
								@RequestParam("lang") String lang) {
		System.out.println("\n transfer4 \n");
